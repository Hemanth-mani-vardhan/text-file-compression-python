...
if __name__ == '__main__':
    input_file_path = Path('/text-compression/test.txt')
    compressed_file_path = Path('/text-compression/compressed.bin')
    decompressed_file_path = Path('/text-compression/decompressed.txt')
